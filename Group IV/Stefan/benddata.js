...
let data = bands.map((element) => element.tags);
console.log(data)

let data1 = bands.map((element) => element.albums)
console.log(data1)

let data2 = bands.map((element) => element.members)
console.log(data2)

let data3 = bands.map((element) => element.name)
console.log(data3)

let data4 = bands.map((element) => element.active)
console.log(data4)
