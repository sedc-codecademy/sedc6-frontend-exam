$(document).ready(function () {
            ...
            function sortTable(arr) {
                ...
                for (i = 0; i < arr.length; i++) {
                    ...
                    for (j = 0; j < arr[i].members.length; j++) {
                        if (arr[i].members[j].former == true) {

                        } else {
                            members.push(arr[i].members[j]);
                        }
        ...
        <tr>
            ...
            <td>${arr[i].name}</td>
            <td>${arr[i].active}</td>
            <td>${members.map(x => x.name + "</br>")}</td>
            <td>${arr[i].albums.length}</td>
        </tr>
        `
                }
           }
           ...
           sortTable(bands);
             ...
             $("#name").click(function (event) {
                    ...
                    var result = bands.sort(function (a, b) {
                ...
                $("#num-albums").click(function (event) {
                    event.preventDefault();
