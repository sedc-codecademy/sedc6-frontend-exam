...
//                 this.nameOfBand = this.nameOfBand.sort(sortingFunction);
//             }

//             // this.tbody.html("");
//             // this.nameOfBand.forEach(bands => {
//             //     let row = $("<tr>");
//             //     $("<td>").text(band.name).appendTo(row);
//             //     $("<td>").text(band.BandActive).appendTo(row);
...
//              var tr = "<tr>"
//              tr += "<td>"+bands[i].name+"</td>";
//              tr += "<td>"+bands[i].bandActive+"</td>";
//              tr += "<td>"+bands[i]+"</td>";
//              tr += "<td>"+bands[i]+"</td>";
//              tr += "</tr>";
//              t += tr;
...
//                 case '1':
//                     sortingFunction = (a, b) => {
//                         return a.nameOfBand - b.nameOfBand;
//                     }
//                     break;
//                 case '2':
//                     sortingFunction = (a, b) => {
...
//                 case '3':
//                     sortingFunction = (a, b) => {
//                         return parseInt(a.bandActive) - parseInt(b.bandActive)
//                     }
//                     break;
//                 default:
//                     break;
